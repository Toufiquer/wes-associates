...
const FormSubmissionPageContent = () => {
  ...
  if (!pathTitle) {
    return (
      <main className="min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-purple-950 to-slate-950 flex flex-col items-center justify-center p-6 text-center text-slate-100">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="max-w-md w-full bg-white/10 backdrop-blur-xl border border-white/40 rounded-sm p-8 flex flex-col items-center gap-6 shadow-2xl"
        >
          ...
          <div className="space-y-2">
            <h1 className="text-2xl font-black tracking-tight text-white">Path Parameter Missing</h1>
  ...
  if (isPagesLoading) {
    return (
      <main className="min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-purple-950 to-slate-950 p-2 flex items-center justify-center">
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-purple-950 to-slate-950 p-2 text-slate-100">
      <div className="max-w-6xl mx-auto space-y-6 p-4">
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-4 shadow-2xl relative overflow-hidden flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="space-y-2">
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <h1 className="text-2xl sm:text-xl font-bold text-white bg-clip-text text-transparent bg-gradient-to-r from-blue-200 to-purple-200">Form Submissions</h1>
        ...
        <div className="border border-white/40 rounded-sm bg-white/10 overflow-hidden backdrop-blur-xl relative shadow-2xl">
          {isSubmissionsLoading ? (
            ...
            <div className="max-w-[400px] md:max-w-full overflow-x-scroll md:overflow-x-auto">
              <table className="w-full text-sm text-left">
                <thead className="bg-white/5 text-slate-300 uppercase font-black tracking-tight text-xs">
                  <tr>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-slate-400">
          <div className="flex items-center gap-2">
            ...
            >
              <SelectTrigger className="h-8 w-[70px] bg-white/5 border-white/20 text-white">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex gap-1">
              <Button
                variant="outline"
                size="icon"
                className="border-white/20 bg-white/5 hover:bg-white/10 disabled:opacity-50 min-w-1 text-white"
        ...
        {isDialogOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-in fade-in duration-200">
            <motion.div
              ...
              className="bg-blue-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-30 border border-gray-100 text-white shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh]"
            >
              <div className="flex items-center justify-between p-6 border-b border-white/10 bg-white/5">
                <h2 className="text-xl font-black tracking-tight text-white flex items-center gap-2">
                  <Plus className="h-5 w-5 text-blue-200" /> New Submission
                </h2>
        ...
        {isViewOpen && viewingSubmission && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-md animate-in fade-in duration-300">
            <motion.div
              ...
              className="bg-blue-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-30 border border-gray-100 text-white shadow-2xl w-full max-w-3xl overflow-hidden flex flex-col max-h-[85vh] mt-[60px]"
            >
              <div className="flex items-center justify-between p-6 border-b border-white/10 bg-white/5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-xl font-black tracking-tight text-white">Submission Details</h2>
                ...
                <div className="w-full">
                  <table className="w-full text-left border-collapse">
                    <thead className="bg-white/5 sticky top-0 z-10 backdrop-blur-md">
                      <tr>
                        <th className="py-3 px-6 text-xs font-black text-slate-400 uppercase tracking-tight border-b border-white/10 w-1/3">Field Name</th>
                        <th className="py-3 px-6 text-xs font-black text-slate-400 uppercase tracking-tight border-b border-white/10 w-2/3">Value</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-white/5">
        ...
        {isDeleteOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-in fade-in duration-200">
            <motion.div
              ...
              className="bg-blue-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-30 border border-red-500/30 text-white shadow-2xl w-full max-w-md p-6"
            >
              <div className="flex items-center gap-4 text-red-400 mb-4">
                <div className="p-3 bg-red-500/10 rounded-full">
                  <AlertTriangle className="h-6 w-6" />
                </div>
                <h3 className="text-xl font-black tracking-tight text-white">Delete Entry?</h3>
              </div>
