...
import { AssetGridLayout, AssetMobileGridLayout, AssetSortMode, defaultDataAsset2, IAssetData, TemplateItem, templateImagePlaceholder } from './data';
...
const normalizeSettings = (data?: IAssetData): IAssetData => ({
  ...defaultDataAsset2,
  ...data,
  title: data?.title || data?.sectionTitle || defaultDataAsset2.title,
  sortMode: data?.sortMode || defaultDataAsset2.sortMode,
  gridLayout: data?.gridLayout || defaultDataAsset2.gridLayout,
  mobileGridLayout: data?.mobileGridLayout || defaultDataAsset2.mobileGridLayout,
  showSeeMore: data?.showSeeMore ?? defaultDataAsset2.showSeeMore,
  showBottomNavigation: data?.showBottomNavigation ?? defaultDataAsset2.showBottomNavigation,
  seeMore: {
    ...defaultDataAsset2.seeMore,
    ...(data?.seeMore || {}),
    name: data?.seeMore?.name || data?.viewMoreText || defaultDataAsset2.seeMore.name,
  },
  templates: data?.templates?.length ? data.templates : defaultDataAsset2.templates,
});
...
const MutationAsset2 = ({ data, onSubmit }: AssetFormProps) => {
  ...
  const importedProductsGridClassName = mutationGridLayoutClasses[settings.gridLayout] || mutationGridLayoutClasses[defaultDataAsset2.gridLayout];
