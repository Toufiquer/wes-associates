...
import { defaultDataPage9, IPage9Data, Page9Props, TeamMember } from './data';
...
const normalizeData = (value: unknown): IPage9Data => {
  ...
  if (!data.ceo || !Array.isArray(data.rows)) return defaultDataPage9;
...
const ConnectorCurve = () => (
  ...
  >
    <motion.path
      ...
      fill="none"
      stroke="url(#Page9ThreadGradient)"
      strokeWidth="1.5"
      strokeDasharray="4 8"
      strokeLinecap="round"
    ...
    />
    <defs>
      <linearGradient id="Page9ThreadGradient" x1="0" y1="0" x2="0" y2="1">
