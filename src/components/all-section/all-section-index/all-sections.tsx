...
export const AllSections = {
  ...
  'section-uid-50': { name: 'Statistics', category: allSectionCagegory[0], mutation: MutationSection50, query: QuerySection50, data: defaultDataSection50 },
  'section-uid-51': { name: 'About WES', category: allSectionCagegory[0], mutation: MutationSection51, query: QuerySection51, data: defaultDataSection51 },
  'section-uid-52': { name: 'Why Choose Us', category: allSectionCagegory[0], mutation: MutationSection52, query: QuerySection52, data: defaultDataSection52 },
  'section-uid-53': {
    name: 'Study Destinations',
    category: allSectionCagegory[0],
    mutation: MutationSection53,
    query: QuerySection53,
    data: defaultDataSection53,
  },
  'section-uid-54': {
    name: 'Student Journey',
    category: allSectionCagegory[0],
    mutation: MutationSection54,
    query: QuerySection54,
    data: defaultDataSection54,
  },
  'section-uid-55': {
    name: 'Student Services',
    category: allSectionCagegory[0],
    mutation: MutationSection55,
    query: QuerySection55,
    data: defaultDataSection55,
  },
  'section-uid-56': {
    name: 'Admission Process',
    category: allSectionCagegory[0],
    mutation: MutationSection56,
    query: QuerySection56,
  ...
  'section-uid-60': {
    ...
    category: allSectionCagegory[0],
    mutation: MutationSection60,
    query: QuerySection60,
    data: defaultDataSection60,
  },
  'section-uid-61': {
    name: 'Appointment Form',
    category: allSectionCagegory[0],
    mutation: MutationSection61,
    query: QuerySection61,
    data: defaultDataSection61,
  },
  'section-uid-62': {
    name: 'Document Checklist',
    category: allSectionCagegory[0],
    mutation: MutationSection62,
    query: QuerySection62,
    data: defaultDataSection62,
  },
