...
const getSectionData = (data?: ISection66Data | string): ISection66Data => {
  ...
  if (typeof data === 'string') {
    try {
      ...
      return { ...defaultDataSection66, ...parsed, faqs: parsed.faqs || defaultDataSection66.faqs };
    } catch {
      return defaultDataSection66;
    }
  }

  return { ...defaultDataSection66, ...data, faqs: data.faqs || defaultDataSection66.faqs };
};
