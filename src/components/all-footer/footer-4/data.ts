...
export const defaultDataFooter4: IFooter4Data = {
  ...
  tagline: 'Professional study abroad consultancy for students from Bangladesh, with support for consultation, admission, scholarship, documentation, and visa guidance.',
